          ...
          <div className='bg-white p-4 rounded max-w-sm w-full'>
            ...
            <form onSubmit={handleClickRegister}>
              ...
              <div className='mb-2'>
                ...
                <input type='text' name='seq' defaultValue={car?.seq} />
              </div>
              <div className='mb-2'>
                <div>
                  <label>メーカー</label>
                </div>
                <input type='text' name='maker' defaultValue={car?.maker} />
              </div>
              <div className='mb-2'>
                <div>
                  <label>型式</label>
              ...
              <div className='mb-2'>
                ...
                <input type='text' name='modelYear' defaultValue={car?.modelYear} />
              </div>
              <div className='mb-2'>
                <div>
                  <label>ナンバープレート</label>
                </div>
                <input type='text' name='licensePlate' defaultValue={car?.licensePlate} />
              </div>
              <div className='mb-2'>
                <div>
                  <label>燃料タンク</label>
                </div>
                <input type='text' name='tankCapacity' defaultValue={car?.tankCapacity} />
              </div>
